...
#define SENDER 0 // rank of sender, used for testing purposes
#define D_SIZE 2 // size of data array, used for testing purposes
...
int main(int argc, char *argv[]){
	...
	/* Gets the input arguments that will be used as the dimensions of the process table */
	...
	/* TEST - send a DRESP packet */
	send_packet_dresp(sba_system);

	/* TEST - send a non-DRESP packet */	
...
void send_packet_dresp(System& sba_system){
	...
	if (sba_system.get_rank() == 0) {
		...
		/* Create the header and the packet */
