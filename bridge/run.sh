...
if mpic++ -pthread -std=c++11 -DBRIDGE -DNBRIDGES=1 -DTHREADED_SEND -DVERBOSE -DMPI_TOPOLOGY_OPT -Wall -Werror main.cc System.cc Tile.cc Transceiver.cc Packet.cc Bridge.cc; then		# COMPILATION
