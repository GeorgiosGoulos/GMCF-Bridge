...
if mpic++ -pthread -std=c++11 -DVERBOSE -DEVALUATE -DMPI_TOPOLOGY_OPT -DBRIDGE -Wall -Werror main.cc System.cc Tile.cc Transceiver.cc Packet.cc Bridge.cc; then		# COMPILATION
